...
class BankUi:
    def __init__(self,root):
        self.root = root
        self.header = Label(self.root,text="XYZ BANK",bg="#0019fc",fg="white",font=("arial",20,"bold"))
        self.header.pack(fill=X)
        self.frame = Frame(self.root,bg="#0019fc",width=800,height=500)
        root.geometry("800x500")
        self.button1 = Button(self.frame,text="Welcome to XYZ Bank. Click to begin transactions",bg="#50A8B0",fg="white",font=ARIAL,command = self.begin_page)
    ...
    def withdraw_money_page(self):
        ...
        self.label5 =Label(self.frame,text="4. If your face is not reconized after 15 seconds, you will automatically be given 2 trial more.",bg="#0019fc",fg="white",font=ARIAL)
        ...
        self.label7.place(x=100,y=220,width=600,height=20)
    ...
    def enroll_user(self):
        ...
        self.pentry = Entry(self.frame,bg="honeydew",show="*",highlightcolor="#50A8B0",
           highlightthickness=2,
            highlightbackground="white")  
        self.button1 = Button(self.frame,text="Click to enroll",bg="#50A8B0",fg="white",font=ARIAL,command = self.write_to_csv)
        self.button2 = Button(self.frame,text="Click to go to video capture after enrolling",bg="#50A8B0",fg="white",font=ARIAL, command = self.video_capture_page)
        self.q = Button(self.frame,text="Quit",bg="#50A8B0",fg="white",font=ARIAL,command = self.root.destroy)
        self.b = Button(self.frame,text="Back",bg="#50A8B0",fg="white",font=ARIAL,command = self.begin_page)
    ...
    def verify_user(self):
        ...
        if self.givenpentry.get() == self.gottenpassword:
    ...
    def write_to_csv(self):
        ...
        with open(r'bank_details.csv','a', newline = '\n') as f:
            writer = csv.writer(f)
            writer.writerow([unique_id,name,account_number,bank, password, account_balance])
    ...
    def video_check(self):
        ...
        self.real_user = int(Counter(real_user_list).most_common(1)[0][0][:-2])
        print(self.real_user)
        if self.real_user == 'Unkown':
            self.video_check()
        else:
